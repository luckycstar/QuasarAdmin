      ...
      <section class="col-9">
        <!-- <q-card class="my-card mainShadow"> -->
          ...
          <q-toolbar class="bg-blue-grey text-white" style="width: 100%">
            <div class="q-ml-lg text-h5 text-weight-bold">Trainee Information</div>
            <q-space />
        ...
        <q-tabs
          ...
          @click="tabSelected()"
        >
          <q-tab name="publist" label="Trainees" />
          <q-tab name="authors" label="Members" />
          <q-tab name="abstract" label="Business Manager" />
                ...
                <q-card-text class="px-5">
                  ...
                  >
                    <e-columns>
                     ...
                     <e-column field="Edit_Link" headerText="Edit Link" width="100"  :valueAccessor="editInformation" :disableHtmlEncode="false"  ></e-column>
                      <e-column field="First" headerText="First" width="75" ></e-column>
                      <e-column field="Last" headerText="Last" width="125"></e-column>
                       <e-column field="Email" headerText="Email" width="125"></e-column>                      
                      <e-column field="Status" headerText="Status" width="75"></e-column>                      
                      <e-column field="Mentor" headerText="Mentor" width="75"></e-column>
                      <e-column field="Mentors_Email" headerText="Mentors_Email" width="75"></e-column>
                      <e-column field="Manager" headerText="Business_Manager" width="125"></e-column>

                    <e-column field="Manager_Email" headerText="Managers_Email" width="125"></e-column>

                   <!-- <e-column field="Edit_Link" headerText="Edit Link" width="175"  :valueAccessor="editInformation" ></e-column> -->
                       <e-column field="Manager_Edit" headerText="Manager Edit" width="100"  :valueAccessor="editManagerInformation" :disableHtmlEncode="false"  ></e-column>
...
import FAQDialog from "../dialogs/trainee_faq"
import InstructionsDialog from "../dialogs/trainee_instructions"
...
export default {
  ...
  //    alert("hide");
    ...
    editInformation: function(field,data,column){
           let url = data["Edit_Link"];
          if (url != ""){
     ...
     editManagerInformation: function(field,data,column){
           let url = data["Manager_Edit"];
  if (url != ""){

         return  ("<a href='" + url + "' target='_blank'>Manager Edit</a>" )
           } else {
               return  ("" )
          }
    ...
    getTrainees(){
    let dbid = "1000"; //this.$store.getters.dbid;
      //var self = this;
      this.$axios
        .get(
          "https://restapi20190104050748.azurewebsites.net/api/GetTrainees/" +
            dbid
        )
        .then(res => {       
          this.traineesNames = JSON.parse(res.data);
       //   }
        })
        .catch(err => {
          alert(err);
