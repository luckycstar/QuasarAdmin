          ...
          <q-scroll-area class="fit">
            <q-list padding>
              <q-item
                clickable
                v-ripple
                :active="$route.name == 'Child5' ? true : false"
                @click="$router.replace({ name: 'Child5' })"
              >
                <q-item-section> Child5 </q-item-section>
              </q-item>

              <q-item
                :active="$route.name == 'Child6' ? true : false"
                clickable
                v-ripple
                @click="$router.replace({ name: 'Child6' })"
              >
                <q-item-section> Child6 </q-item-section>
              </q-item>
            </q-list>
          </q-scroll-area>
...
export default {
  ...
  created() {
    this.$router.push({ name: "Child5" }).catch(() => {});
  },
